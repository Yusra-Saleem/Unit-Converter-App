...
export default function UnitConverterComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-sky-200">
      ...
      <div className="max-w-md w-full  p-4 sm:p-5  bg-sky-600 rounded-xl shadow-2xl">
        <div className="xxs:px-3 xxs:py-7 -3 xs:p-7   w-full  text-slate-800 bg-sky-100 rounded-xl">
          <h1 className="xxs:text-3xl xs:text-4xl font-bold uppercase text-slate-900 mb-1 text-center">Unit Converter</h1>
          <p className="text-lg mb-8  text-slate-800 text-center font-semibold">
            Convert values between different units.
          </p>
          <div className="grid grid-cols-2 text-white  gap-4">
            {/* Select for input unit */}
            <div className="space-y-2">
              <Label htmlFor="input-unit" className="text-blue-950 text-lg font-bold">From</Label>
              <Select onValueChange={handleInputUnitChange}>
                <SelectTrigger className=" xxs:px-2 xs:px-4 border-4 rounded-xl font-semibold tracking-wider border-blue-300 sm:px-6 bg-gradient-to-r from-slate-800 to-sky-500">
                  <SelectValue placeholder="Select unit" />
                </SelectTrigger>
                <SelectContent className="text-slate-800 xxs:text-xs xxs:p-0 h-60 rounded-xl bg-gray-200">
            ...
            <div className="space-y-2">
              <Label htmlFor="output-unit" className="text-blue-950 text-lg font-bold">To</Label>
            ...
            <div className="space-y-2 col-span-2 mt-6">
              <Label htmlFor="input-value" className="text-blue-950 text-lg font-bold flex flex-col items-center">Value</Label>
              <Input
                id="input-value"
                type="number"
                ...
                className="w-full border-4 rounded-xl font-semibold tracking-wider border-blue-300 px-6 bg-gradient-to-r from-slate-800 to-sky-500"
              />
            </div>
            {/* Button to trigger conversion */}
            <Button
              type="button"
              className="col-span-2 mt-3 bg-slate-800 text-primary-foreground hover:bg-gray-600 border-2 border-sky-500 rounded-2xl focus-visible:outline-double focus-visible:ring-1 focus-visible:ring-ring" 
          ...
          <div className="mt-6 text-center ">
            <div className="text-4xl font-bold " style={{ textShadow: '3px 4px 3px rgba(37, 99, 235, 0.7)' }}>
